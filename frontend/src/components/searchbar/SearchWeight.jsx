...
function SearchWeight() {
  ...
  let url = "http://ec2-44-203-185-207.compute-1.amazonaws.com:8080/fighter?weight=" + inputValue
  let allUrl = "http://ec2-44-203-185-207.compute-1.amazonaws.com:8080/fighter?weight="
    ...
    <div className="searchName">
      ...
      <div className='search-function'>
        <div className='search-bar'>
          ...
          <input className='input-label' placeholder='Search Athlete By Weight' onChange={handleChange} value={inputValue} type='text' onKeyDown={handleKeyDown} />
        </div>
      </div>
