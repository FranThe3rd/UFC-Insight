...
function SearchName() {
  ...
  let url = "http://ec2-44-203-185-207.compute-1.amazonaws.com:8080/fighter?name=" + inputValue;
  let allUrl = "http://ec2-44-203-185-207.compute-1.amazonaws.com:8080/fighter";
